...
export function FilterCondition({ node, columns, types, updateNode, removeNode }) {
    ...
    return (
        <div className="flex items-center gap-2 mb-2 p-2 bg-white rounded border border-gray-200 shadow-sm animate-in fade-in zoom-in duration-200">
            <div className="text-gray-400 text-sm font-medium w-16">Where</div>
